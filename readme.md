...
| Live Browser Reloading | Reload the browser in real-time whenever you edit your file without any need of extension. Brought to you by [Browsersync](https://www.browsersync.io). (Run `npm serve` for developing or `npm build` for production) |
### Quickstart
Make sure you have installed **node.js** on your computer. [Download]() the kit or clone this repository. Run `npm install` first to install the dependencies. Then build your project in `src` directory.
